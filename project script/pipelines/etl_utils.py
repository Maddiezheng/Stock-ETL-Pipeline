...
def push_to_s3(
    ...
    access_key='stocklake',
    secret_key='stocklake',
    bucket_name='stocklake',
):
...
def deduplication(table_name: str, spark: SparkSession, filter_condition: str=None, storage_path='s3a://stocklake/delta'):
    pass
...
def run_data_validations(
        df,
        data_asset_name: str,
        root_dir: str='/opt/spark/work-dir/stocklake/data_quality',
    ):
    pass
